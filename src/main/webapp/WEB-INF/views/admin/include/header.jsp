...
if('${msg_fail}' !='') {//자바의 EL표기법 달라{변수명}
	alert("${msg_fail}를(을) 실행하지 못했습니다.");
}
</script>
  <meta charset="utf-8">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img onerror="this.src='resources/dist/img/default-150x150.png'" style="width:40px;height:40px;" src="/resources/profile/${session_userid}.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">

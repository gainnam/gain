		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-12">
					...
					<!-- form start -->
					<form encType="multipart/form-data" name="write_form" action="/admin/member/member_write"
						method="post">
						...
						<div class="card card-primary">
                    	 ...
                    	 값을 전송하게 되는데, 전송값을 담아두는 이름이 name가 되고, 위에서는 user_id 입니다. -->
									...
									<div class="custom-file">
										<input accept=".jpg" type="file" name="file"
											class="custom-file-input" id="customFile_${index}"> <label
									...
									<div class="form-group">
										<label for="point">point</label> <input type="number"
							...
							<div class="card-body">
								...
								<button type="submit" class="btn btn-danger float-right mr-1"

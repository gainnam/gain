...
public class DataSourceTest {
	...
	public String memberPrimaryKey() throws Exception {
		//사용자 프라이머리키 생성하는 메서드 년월일시분처 + 밀리초 대량더미입력 시 Unique error발생 -> UUID로 변경->countMember로 변경
		/*
	...
	public void oldQueryTest() throws Exception {
		...
		connection = DriverManager.getConnection("jdbc:hsqldb:file:c:/egov/workspace/embeded/hsql_file.db");
		/* mysql(마리아DB)
		.getConnection("jdbc:log4jdbc:mysql:/127.0.0.1:3306/edu", "root", "app)
		 */
		//직접 쿼리를 날립니다.(아래)
